...
namespace ToDo.Controllers
{
    public class ItemsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ItemID,Name,DueDate,Details,IsDone,ListID")] Item item)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ItemID,Name,DueDate,Details,IsDone,ListID")] Item item)
        {
            if (ModelState.IsValid)
            {
